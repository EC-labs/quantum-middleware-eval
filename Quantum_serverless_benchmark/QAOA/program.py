...
def run_qaoa(
    ...
    return minimize(
        ...
        method=method,
        options={'maxiter': max_iterations} if max_iterations is not None else {}
    )
...
if __name__ == "__main__":
    ...
    iterations = arguments.get("iterations")  # Retrieve iterations argument
    ...
    result = run_qaoa(ansatz, estimator, operator, initial_point, method, iterations)
